...
create_clock -period 100.000 -name jtag1/BSCANE2_inst/TCK -waveform {0.000 50.000} [get_pins jtag1/BSCANE2_inst/TCK]
create_clock -period 10.000 -name clk_p -waveform {0.000 5.000} [get_ports clk]
